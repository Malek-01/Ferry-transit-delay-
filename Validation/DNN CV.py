...
def preprocess_data(data):
    """Preprocess the dataset: encode non-numeric columns, handle missing values."""
...
def train_model(X_train, y_train):
    """Train a MLPRegressor model with GridSearchCV."""
    ...
    grid_search = GridSearchCV(estimator=dnn_model, param_grid=param_grid, scoring='neg_mean_squared_error', cv=5)
